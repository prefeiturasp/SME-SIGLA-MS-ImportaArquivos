...
class TestApiEscolhasServiceEscolhasProdam:
    ...
    def test_enviar_escolhas_prodam_sucesso(self) -> None:
        ...
        with patch('sigla_sdk.http.api_client.http_client.post') as mock_post:
            ...
            response = service.enviar_escolhas_prodam(processo_uuid=processo_uuid, concurso_uuid=concurso_uuid, dados_prodam=dados_prodam)
    ...
    def test_enviar_escolhas_prodam_com_headers_customizados(self) -> None:
        ...
        with patch('sigla_sdk.http.api_client.http_client.post') as mock_post:
            ...
            mock_resp.status_code = 200
            mock_post.return_value = mock_resp
            service.enviar_escolhas_prodam(processo_uuid='123e4567-e89b-12d3-a456-426614174000', concurso_uuid='223e4567-e89b-12d3-a456-426614174000', dados_prodam=dados_prodam, headers=custom_headers)
            args, kwargs = mock_post.call_args
    ...
    def test_enviar_escolhas_prodam_erro_http_levanta_excecao_especifica(self) -> None:
        ...
        mock_response.json.return_value = {'detail': 'Erro externo de escolhas', 'code': 'ERRO_ESCOLHAS', 'detalhes': 'Payload inválido'}
