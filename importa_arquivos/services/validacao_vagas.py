...
def validar_csv_vagas(arquivo, importacao_obj=None) -> Tuple[List[Dict], List[Dict]]:
    ...
    try:
        ...
        raise LeituraCSVException('Erro ao ler arquivo de Vagas', detalhes=f'Não foi possível ler o arquivo CSV. Detalhes: {str(exc)}')
    ...
    if headers_csv != colunas_esperadas:
        ...
        mensagem_erro = 'Arquivo de Vagas inválido'
        detalhes_lista = []
