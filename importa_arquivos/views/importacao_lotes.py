...
from ..services.exceptions import BaseImportacaoException, ErrosValidacaoLotesException, ImportacaoBadRequestException, ImportacaoServiceUnavailableException
...
class ImportacaoLotesViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request: Any, *args: Any, **kwargs: Any) -> Any:
        ...
        try:
            total = ApiCandidatosService(base_url=settings.CANDIDATOS_API_URL).salvar_lotes(concurso_uuid=concurso_uuid, lotes=registros, importacao_obj=instance)
