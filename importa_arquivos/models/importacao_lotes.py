...
class ImportacaoLotes(BaseModelArquivoImportacao):
    ...
    concurso_nome = models.CharField(
        max_length=255, null=True, blank=True, verbose_name="Nome do Concurso"
    )
    total_atualizados = models.IntegerField(
        null=True, blank=True, verbose_name="Total de Candidatos Atualizados"
    )
    detalhes = models.JSONField(
        null=True, blank=True, verbose_name="Detalhes da Atualização"
    )
