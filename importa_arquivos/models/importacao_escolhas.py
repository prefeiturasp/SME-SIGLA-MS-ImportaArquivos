...
class ImportacaoEscolhas(BaseModel):
    ...
    dados_prodam = models.JSONField(verbose_name='Dados da importação da API PRODAM', null=True, blank=True)
    status = models.CharField(max_length=20, choices=CHOICES_STATUS_IMPORTACAO_ARQUIVO, default=CHOICES_STATUS_IMPORTACAO_ARQUIVO[2][0], verbose_name='Status')
