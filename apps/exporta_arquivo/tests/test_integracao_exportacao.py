...
com mock apenas da API externa.
...
from exporta_arquivo.api.views import ExportacaoCandidatosProcessoViewSet
...
class TestIntegracaoCreateCandidatosProcesso:
    """executar_exportacao candidatos processo: mock só da API externa."""
