...
class TestExportacaoCandidatosProcessoViewSetEspecifico:
    """create: mock exportar_candidatos_processo e persiste conteúdo."""
    ...
    def test_create_com_mocks_persiste_conteudo_e_nome_arquivo_prefixo_candidatos_processo(  # noqa: E501
        ...
        """Verifica create persiste conteudo e nome com prefixo correto."""
        conteudo_esperado = "conteudo|pipe|formatado\n"
        with patch(
            "exporta_arquivo.api.views.exportacao_candidatos_processo.exportar_candidatos_processo",
        ...
        assert "candidatos_processo_" in response.get(
            "Content-Disposition", ""
        )
...
class TestExportacaoVagasProcessoViewSetEspecifico:
    ...
    def test_create_com_mocks_persiste_conteudo_e_nome_exportacao_vagas_processo(  # noqa: E501
        ...
        with (
            patch(
                "exporta_arquivo.api.views.exportacao_vagas_processo.buscar_vagas_escolas_processo",
                return_value=vagas_escolas,
            ),
            patch(
                "exporta_arquivo.api.views.exportacao_vagas_processo.formatar_arquivo_vagas_processo",
                return_value=conteudo_esperado,
            ),
        ):
            response = api_client.post(
...
class TestExportacaoVagasSigpecViewSetEspecifico:
    ...
    def test_create_com_mocks_persiste_conteudo_sigpec_e_nome_exportacao_vagas_sigpec(  # noqa: E501
        ...
        with (
            patch(
                "exporta_arquivo.api.views.exportacao_vagas_sigpec.buscar_vagas_escolas_sigpec",
                return_value=vagas_escolas,
            ),
            patch(
                "exporta_arquivo.api.views.exportacao_vagas_sigpec.formatar_arquivo_sigpec",
