...
def formatar_arquivo_sigpec(vagas_listas: List[Dict[str, Any]]) -> str:
    """
    Recebe lista de dicts com chaves 'codigo_integracao', 'vagas_definitivas', 'vagas_precarias'
    e retorna a string completa do arquivo (cabeçalho + linhas no formato SIGPEC).
    """
