...
class ExportacaoLote(models.Model):
    ...
    status = models.CharField(max_length=20, choices=StatusExportacao.choices, default=StatusExportacao.SUCESSO, verbose_name='Status da Exportação')
    concurso_uuid = models.UUIDField(verbose_name='UUID do Concurso')
    concurso_nome = models.CharField(max_length=255, verbose_name='Nome do Concurso')
    lote_uuid = models.UUIDField(verbose_name='UUID do Lote')
    numero_lote = models.IntegerField(verbose_name='Número do Lote')
    codigo_cargo = models.CharField(max_length=20, verbose_name='Código do Cargo', null=True, blank=True)
    conteudo_arquivo = models.TextField(verbose_name='Conteúdo do arquivo exportado', null=True, blank=True)
    nome_arquivo = models.CharField(max_length=255, verbose_name='Nome do arquivo exportado', null=True, blank=True)
