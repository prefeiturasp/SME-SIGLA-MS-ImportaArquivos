...
class TestIntegracaoCreateCandidatosProcesso:
    ...
    def test_create_mockando_apenas_api_externa_retorna_200_e_arquivo_txt(self, api_client: Any) -> Any:
        ...
        with patch('sigla_sdk.http.api_client.http_client.get', side_effect=fake_get):
            response = api_client.post(self.URL, {'processo_uuid': _uuid(), 'cargo_uuid': _uuid(), 'cargo_codigo': 10, 'concurso_uuid': concurso_uuid, 'processo_nome': 'Processo Integração', 'cargo_nome': 'Cargo Teste'}, format='json')
