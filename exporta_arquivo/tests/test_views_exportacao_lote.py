...
from exporta_arquivo.services.exceptions import ExportacaoBadRequestException, ExportacaoLoteIncompletaException
...
class TestExportacaoLoteList:
    ...
    def test_lista_retorna_campos_do_list_serializer(self, api_client: Any, registro_exportado: Any) -> None:
        ...
        for campo in ('uuid', 'criado_em', 'atualizado_em', 'concurso_uuid', 'concurso_nome', 'numero_lote', 'lote_uuid', 'nome_arquivo', 'status'):
