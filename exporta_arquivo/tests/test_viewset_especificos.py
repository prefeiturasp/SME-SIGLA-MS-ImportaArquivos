"""
Testes específicos de cada ViewSet concreta: qual service é chamado e formato do arquivo.
O restante (list, create com exceções, download, get_serializer_class) já está na base.
"""
import uuid
...
class TestExportacaoCandidatosProcessoViewSetEspecifico:
    """Create: mock exportar_candidatos_processo e formatar_arquivo_candidatos_processo; persiste conteúdo e nome com prefixo candidatos_processo_."""
...
class TestExportacaoVagasProcessoViewSetEspecifico:
    """Create: mock buscar_vagas_escolas e formatar_arquivo_vagas_processo; persiste e nome exportacao-vagas-processo-..."""

    URL = "/api/v1/exportacao/vagas-processo/"

    def test_create_com_mocks_persiste_conteudo_e_nome_exportacao_vagas_processo(self, api_client):
        vagas_escolas = [
            {"codigo_eol": "EOL1", "vagas_definitivas": 2, "vagas_precarias": 1},
        ]
...
class TestExportacaoVagasSigpecViewSetEspecifico:
    """Create: mock buscar_vagas_escolas e formatar_arquivo_sigpec; nome exportacao-vagas-sigpec-... e conteúdo formato SIGPEC."""

    URL = "/api/v1/exportacao/vagas-sigpec/"

    def test_create_com_mocks_persiste_conteudo_sigpec_e_nome_exportacao_vagas_sigpec(self, api_client):
        vagas_escolas = [
            {"codigo_integracao": "SETOR01", "vagas_definitivas": 3, "vagas_precarias": 0},
        ]
