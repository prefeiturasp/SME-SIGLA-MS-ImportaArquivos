...
formatar_arquivo_vagas_processo + buscar_vagas_escolas (mock de ApiEscolhasService).
Sem HTTP/DB.
"""
...
class TestFormatarArquivoVagasProcesso:
    """Formato esperado: codigo_cargo|codigo_eol|v_def|v_prec por linha, sem cabeçalho."""
    ...
    def test_varias_linhas(self):
        linhas = [
            {"codigo_eol": "EOL1", "vagas_definitivas": 1, "vagas_precarias": 0},
            {"codigo_eol": "EOL2", "vagas_definitivas": 0, "vagas_precarias": 2},
        ]
...
class TestBuscarVagasEscolasVagasProcesso:
            ...
            "vagas": [
                {
                    "vagas_definitivas": 2,
                    "vagas_precarias": 1,
                    "escola": {"codigo_integracao": "INT001", "codigo_eol": "123456"},
                    "cargo_codigo": 100,
                },
            ],
        }
    ...
    def test_payload_invalido_serializer_levanta_erro(self):
        ...
        payload_invalido = {"vagas": []}  # validate_vagas exige pelo menos uma vaga
        mock_api = MagicMock()
